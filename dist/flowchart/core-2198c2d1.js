...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_flowchart('./css-shim-6aaf713d-9b13816a.js').then(() => {
...
const patchBrowser = () => {
    ...
    if (importMeta !== '') {
        ...
        if (!window.customElements) {
            ...
            // @ts-ignore
            return __sc_import_flowchart('./dom-76cc7c7d-0a082895.js').then(() => opts);
        }
    }
    ...
    if ((BUILD.lazyLoad || BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (BUILD.style && !styles.has(scopeId) && Cstr.style) {
            ...
            if (!BUILD.hydrateServerSide && BUILD.shadowDom && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await __sc_import_flowchart('./shadow-css-4889ae62-23996f3f.js').then(m => m.scopeCss(style, scopeId, false));
            }
